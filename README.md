...
### Notes while implementing/testing
...
Keep in mind, valid_moves returns a list of valid moves for a given cell. It is completely fine for the method it return an empty list.
...
So, the next challenge is, how do we determine if a piece is pinned?
